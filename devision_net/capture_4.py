...
if __name__ == '__main__':
    ...
    # run_capture(
    #     num_modules=1,
    #     out_dir=r'C:\...\3D_1module_dataset_max_DAC'
    # )

    # 2モジュール用
    # run_capture(
    #     num_modules=2,
    #     out_dir=r'C:\...\3D_2module_dataset_max_DAC'
    # )

    # 3モジュール用
    # run_capture(
    #     num_modules=3,
    #     out_dir=r'C:\...\3D_3module_dataset_max_DAC'
    # )

    # 4モジュール用
    run_capture(
        num_modules=4,
        out_dir=r'C:\Users\ishiz\Documents\Akamine_workspace\master_thesis_2025\SMR_control_3D\devision_net\devnet_data_new\4module_dataset_max_DAC'
    )